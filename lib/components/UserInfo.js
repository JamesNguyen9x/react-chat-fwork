...
var UserInfo = function (_Component) {
  ...
  function UserInfo() {
    ...
    }, _this.createRoom = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('img', { src: this.props.user.profile.avatar, alt: 'status-icon', onClick: this.createRoom,
            className: 'rounded-circle user_img' }),
          _react2.default.createElement('span', { className: 'online_icon' + (this.props.user.status === 1 ? ' offline' : '') })
        ),
        _react2.default.createElement(
          'div',
