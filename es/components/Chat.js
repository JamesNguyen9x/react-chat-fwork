...
var Chat = function (_Component) {
  ...
  function Chat(props) {
    ...
    _this.connectSocket = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
    ...
    _this.listenEvent = function () {
      ...
      window.socket.on('user_change_status', function (data) {
        ...
        if (index >= 0) {
          ...
          _this.setState({
            rooms: update(_this.state.rooms, (_update = {}, _update[index] = { status: { $set: data.status } }, _update))
          });
        }
      });
      ...
      window.socket.on('new_message', function (data) {
        ...
        clearTimeout(_this.timeoutStopTyping);
        _this.setState({
          rooms: update(_this.state.rooms, (_update2 = {}, _update2[index] = {
      ...
      window.socket.on('new_message_liked', function (data) {
        ...
        _this.setState({
          rooms: update(_this.state.rooms, (_update3 = {}, _update3[index] = {
      ...
      window.socket.on('new_message_room_off', function (data) {
        ...
        unreadMessage++;
        _this.setState({
          rooms: update(_this.state.rooms, (_update4 = {}, _update4[index] = { unreadMessage: { $set: unreadMessage } }, _update4))
        });
      });
    };
    ...
    _this.getRoomsActiveFromSession = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
    ...
    _this._onMessageWasSent = function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(roomId, message) {
        var _update5;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                ...
                _this.setState({
                  rooms: update(_this.state.rooms, (_update5 = {}, _update5[index] = { messageList: { $set: newMessageList } }, _update5))
                }, function () {
                  window.socket.emit('send_message', data, function (result) {
                    ...
                    _this.setState({
                      rooms: update(_this.state.rooms, (_update6 = {}, _update6[index] = {
    ...
    _this.getMemberList = function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(roomId) {
    ...
    _this._getRoomForUser = function (user) {
      ...
      fetchAPI(baseURL, url, 'GET', params).then(function (response) {
    ...
    _this._onLikeMessage = function (mess) {
      ...
      if (message) {
        ...
        _this.setState({
          rooms: update(_this.state.rooms, (_update7 = {}, _update7[index] = {
            messageList: { $set: newListMessage },
            messageSuggest: { $set: '' }
          }, _update7))
        });
    ...
    _this._getMessage = function (roomId) {
      ...
      fetchAPI(baseURL, url, 'GET', params).then(function (response) {
        ...
        if (!messages.length) {
          ...
          _this.setState({
            rooms: update(_this.state.rooms, (_update8 = {}, _update8[index] = {
          ...
          _this.setState({
            rooms: update(_this.state.rooms, (_update9 = {}, _update9[index] = {
    ...
    _this._editGroup = function (data) {
      ...
      return fetchAPI(baseURL, url, 'PUT', null, data).then(function (res) {
        if (res.status === 200) {
    ...
    _this.updateRoom = function (newRoom) {
      ...
      _this.setState({
        rooms: update(_this.state.rooms, (_update10 = {}, _update10[index] = { $set: _extends({}, _this.state.rooms[index], newRoom) }, _update10))
      }, function () {
    ...
    _this._onHideWindow = function (room) {
      ...
      if (_this.state.rooms[index].isHideWindow) {
        ...
        _this.setState({
          rooms: update(_this.state.rooms, (_update11 = {}, _update11[index] = {
            isHideWindow: {
    ...
    _this.rejoinRoom = function () {
      var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(room, index, isSetState) {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 6:
                if (isSetState) {
                  _this.setState({
                    rooms: update(_this.state.rooms, (_update12 = {}, _update12[index] = {
                      isHideWindow: {
                        $set: !_this.state.rooms[index].isHideWindow
                      },
                      messageList: {
    ...
    _this._onReplyMessage = function (message) {
      ...
      _this.setState({
        rooms: update(_this.state.rooms, (_update13 = {}, _update13[index] = { messageReply: { $set: message } }, _update13))
      });
    };
    ...
    _this._onCloseReplyMessage = function (roomId) {
      ...
      _this.setState({
        rooms: update(_this.state.rooms, (_update14 = {}, _update14[index] = { messageReply: { $set: '' } }, _update14))
      });
    };
    ...
    _this.roomList = React.createRef();
    return _this;
  }
